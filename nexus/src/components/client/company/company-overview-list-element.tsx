...
export function CompanyOverviewListElement({company_overview, onClick}: {
...
})
{
    return (
        <div onClick={event => onClick?.(company_overview.company_id, company_overview.ticker_id)}
             className={"p-2 min-w-[14em] mx-auto w-full cursor-pointer shadow-md shadow-gray-800 rounded-lg flex flex-row gap-2 "}>
            <div className={"w-full grid grid-cols-2 sm:hidden items-center gap-3"}>
