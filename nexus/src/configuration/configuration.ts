...
export const IN_DOCKER: boolean = process.env.IN_DOCKER === 'true';
...
const FASTAPI_DOCKER_SERVER_BASE_URL = 'http://backend:8000'

export const FASTAPI_SERVER_BASE_URL = IN_DOCKER ? FASTAPI_DOCKER_SERVER_BASE_URL : (ENVIRONMENT == EnvironmentType.DEVELOPMENT ? FASTAPI_DEVELOPMENT_SERVER_BASE_URL : FASTAPI_PRODUCTION_SERVER_BASE_URL);

const NEXUS_DEVELOPMENT_SERVER_BASE_URL = 'http://localhost:3000'
const NEXUS_PRODUCTION_SERVER_BASE_URL = 'http://localhost:3000'

const NEXUS_DOCKER_SERVER_BASE_URL = 'http://localhost:3000'

export const NEXUS_SERVER_BASE_URL = IN_DOCKER ? NEXUS_DOCKER_SERVER_BASE_URL : (ENVIRONMENT == EnvironmentType.DEVELOPMENT ? NEXUS_DEVELOPMENT_SERVER_BASE_URL : NEXUS_PRODUCTION_SERVER_BASE_URL);
